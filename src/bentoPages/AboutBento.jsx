  ...
  return (
    <div className="w-full h-full" id="about">
      ...
      <div className='w-[100%] h-[30%] mb-6 grid grid-cols-11 gap-6'>
        ...
        >
          <div className='h-[100%] col-span-7 pb-4 bg-neutral-800 shadow-md shadow-[#7f8285] rounded-xl border-2 border-[#ffffff] transition hover:shadow-lg hover:shadow-pink-300 ease-in-out duration-300'> 
