...
function AboutBento() {
  ...
  return (
    <div className="w-full h-full md:mt-7" id="about">
      {/* Top Row */}
      <div className='w-[100%] h-[14%] md:mb-6 mb-3 grid grid-cols-10 md:gap-6 gap-3 md:px-0 px-4'>
        <motion.div
        ...
        >
          <div className='h-[100%] col-span-3 flex flex-col items-center bg-neutral-800 shadow-md shadow-[#7f8285] rounded-xl border-2 border-[#ffffff] transition hover:shadow-lg hover:shadow-pink-300 ease-in-out duration-300'>
            ...
            <div className='flex md:hidden text-[28px] leading-10 text-emerald-300 font-semibold'>3</div>
            <div className='flex md:hidden text-xs leading-3 text-white mb-2 text-center'>Years Experience</div>
          </div> 
        </motion.div>
      ...
      <div className='md:hidden grid w-[100%] h-[30%] md:mb-6 mb-3 grid-cols-1 gap-4 md:px-0 px-4 pb-5'>
        <motion.div
        ...
        >
          <div className='w-full h-fit py-1 flex flex-col items-center justify-center bg-neutral-800 shadow-md shadow-[#7f8285] rounded-xl border-2 border-[#ffffff] transition hover:shadow-lg hover:shadow-pink-300 ease-in-out duration-300'> 
            <div className='px-3 pt-3 text-lg text-white text-center'>
              I am dedicated to crafting 
              <span className='text-lg text-emerald-400'> Responsive</span>, 
              <span className='text-lg text-pink-400'> Imaginative</span>, and
              <span className='text-lg text-emerald-400'> Innovative </span>software applications. 
            </div>
            <div className='px-3 pt-3 text-lg text-white text-center'>
